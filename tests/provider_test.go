...
import (
	...
	ibm-api-connect "github.com/pulumi/pulumi-ibm-api-connect/provider"
)
...
func provider() integration.Server {
	return integration.NewServer(ibm-api-connect.Name, semver.MustParse("1.0.0"), ibm-api-connect.Provider())
}
