...
pulumi.runtime.registerResourceModule("ibm-api-connect", "index", _module)
pulumi.runtime.registerResourcePackage("ibm-api-connect", {
    version: utilities.getVersion(),
    constructProvider: (name: string, type: string, urn: string): pulumi.ProviderResource => {
        if (type !== "pulumi:providers:ibm-api-connect") {
